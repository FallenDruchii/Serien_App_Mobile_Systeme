...
//                lv_Streams.setAdapter(adapter);
            ...
            fab.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    String categoryAndYear = item.getCategoryAndYear();
                    float rating = item.getRating();
                    ArrayList providers = item.getProvider();
                    ArrayList providerlinks = item.getProviderlinks();

                    Listen.getWatchList().add(new Item(title, image, link, description, categoryAndYear, rating, providers, providerlinks));
                    Snackbar.make(v, item.getTitle() + " was added to your Watchlist.", Snackbar.LENGTH_LONG)
